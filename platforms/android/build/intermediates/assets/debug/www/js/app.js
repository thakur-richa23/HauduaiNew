...
.run(function($ionicPlatform) {
 ...
 //localStorage.setItem("status_noti_sub",'question');
 // localStorage.setItem("status_noti",'question');
  //alert(status_noti);
  ...
  var notificationOpenedCallback = function(jsonData){
    ...
    if(jsonData.additionalData.foo == 'community')
    {
        ...
        window.localStorage.setItem("comans_id", id);
        window.location.reload(true);
    }
    else if(jsonData.additionalData.foo == 'student')
    {
        window.localStorage.setItem("status_noti",'answer');
        window.localStorage.setItem("status_noti_sub",'answer_stucommunity');
        var id = jsonData.additionalData.idd;
        location.href="#/stu_queans/"+ id;
        window.location.reload(true);
        window.localStorage.setItem("stuans_id", id);
        window.location.reload(true);
    ...
    else if(jsonData.additionalData.foo == 'waiting_community')
    {
        ...
        window.localStorage.setItem("status_noti_sub",'question');
    ...
    {
        window.localStorage.setItem("status_noti",'question');
        window.localStorage.setItem("status_noti_sub",'question_specialist');
        location.href="#/app/askforexp";
        window.location.reload(true);

    }
    else if(jsonData.additionalData.foo == 'waiting_student'){
        window.localStorage.setItem("status_noti",'question');
        window.localStorage.setItem("status_noti_sub",'question');
        location.href="#/app/askforcomm"; 
        window.location.reload(true);
    ...
    else if(jsonData.additionalData.foo == 'waiting_lecturer'){
        window.localStorage.setItem("status_noti",'question');
        window.localStorage.setItem("status_noti_sub",'question_lec');
        location.href="#/app/askforexp";
        window.location.reload(true);
 
    }
    else if(jsonData.additionalData.foo == 'lecturer'){
    
        window.localStorage.setItem("status_noti",'answer');
        window.localStorage.setItem("status_noti_sub",'answer_stulec');
        var id = jsonData.additionalData.idd;
        location.href="#/stu_expertanswer/"+ id;
        window.location.reload(true);
        window.localStorage.setItem("lecans_id", id);
        window.location.reload(true);
    }
    else if(jsonData.additionalData.foo == 'quiz_prize'){
    ...
    {
        window.localStorage.setItem("status_noti",'answer');
        window.localStorage.setItem("status_noti_sub",'answer_expert');
        //location.href="#/app/questions_to_expert";
        var id = jsonData.additionalData.idd;
        location.href="#/expans/"+ id;
        window.location.reload(true);
        window.localStorage.setItem("expans_id", id);
        window.location.reload(true);
    }
...
.config(function($stateProvider, $urlRouterProvider, $httpProvider) {
 ...
 .state('app.search', {
  ...
  .state('app.stu_search', {
    url: '/stu_search',
    views: {
      'menuContent': {
        templateUrl: 'templates/stu_search.html'
      }
    }
  })
  ...
  .state('app.stu_login', {
    ...
    views: {
      'menuContent': {
        templateUrl: 'templates/stu_login.html'
      }
    }
  })
  ...
  .state('app.stu_feedback_rat', {
    url: '/stu_feedback_rat',
    views: {
      'menuContent': {
        templateUrl: 'templates/stu_feedback_rat.html',
        //controller: 'rateCtrl'
      }
    }
  })
...
.state('app.stu_noans', {
  ...
  .state('app.stu_forgetpass', {
    url: '/stu_forgetpass/:id',
    views: {
      'menuContent': {
        templateUrl: 'templates/stu_forgetpass.html'
      }
    }
  }) 
...
.state('app.stu_ansnoans', {
    url: '/stu_ansnoans/:id',
    views: {
      'menuContent': {
        templateUrl: 'templates/stu_ansnoans.html'
      }
    }
  })
...
.state('app.stu_events', {
    url: '/stu_events',
	views: {
      'menuContent': {
        templateUrl: 'templates/stu_events.html',
        controller: 'stu_eventCtrl',
      }
    },
  ...
  .state('app.browse', {
    ...
    .state('app.stu_news', {
      url: '/stu_news',
        ...
        views: {
      'menuContent': {
        templateUrl: 'templates/stu_news.html',
        controller: 'stu_newCtrl',
      }
    }
    })
    ...
    .state('app.stu_faq', {
      url: '/stu_faq',
        ...
        views: {
      'menuContent': {
        templateUrl: 'templates/stu_faq.html'
      }
    }
    })

    .state('app.stu_earn_points', {
      url: '/stu_earn_points',
      
        views: {
      'menuContent': {
        templateUrl: 'templates/stu_earn_points.html'
      }
    }
    })
    ...
    .state('app.stu_pollsresult', {
		  url: '/stu_pollsresult/:id',
		  
		views: {
		  'menuContent': {
			templateUrl: 'templates/stu_pollsresult.html'
		  }
		},
	...
	.state('app.stu_piechart', {
      url: '/stu_piechart/:id',
      
        views: {
      'menuContent': {
        templateUrl: 'templates/stu_piechart.html'
      }
    },
...
.state('app.rate_que_to_exp', {
      url: '/rate_que_to_exp',
      
        views: {
      'menuContent': {
        templateUrl: 'templates/rate_que_to_exp.html'
      }
    },
	//controller:'resultpieCtrl'
...
.state('app.rate_queto_lec', {
      url: '/rate_queto_lec',
      
        views: {
      'menuContent': {
        templateUrl: 'templates/rate_queto_lec.html'
      }
    },
	//controller:'resultpieCtrl'
    ...
    .state('app.rate_que_to_com', {
      url: '/rate_que_to_com',
      
        views: {
      'menuContent': {
        templateUrl: 'templates/rate_que_to_com.html'
      }
    },
    })

    .state('app.rate_queto_stu', {
      url: '/rate_queto_stu',
      
        views: {
      'menuContent': {
        templateUrl: 'templates/rate_queto_stu.html'
      }
    },
    })
  ...
  .state('app.course_form', {
    url: '/course_form',
    views: {
      'menuContent': {
        templateUrl: 'templates/course_form.html'
...
.state('view_response', {
    url: '/view_response/:id',
    
        templateUrl: 'templates/view_response.html'
...
.state('comentfrmlec', {
    url: '/comentfrmlec/:id/:fid',
    
        templateUrl: 'templates/comentfrmlec.html',
        
   
  })

  .state('commentlecans', {
    url: '/commentlecans/:id/:fid',
    
        templateUrl: 'templates/commentlecans.html',
        
   
  })

  $urlRouterProvider.otherwise('/front_page');
});
